...
public class GetMyPlantResponse extends BaseResponse {
    @SerializedName("Index")public List<MyPlantResponse> response;
    public static class MyPlantResponse extends BaseResponse{
        ...
        @SerializedName("birthday")public int birthday;
        @SerializedName("sun")public int sun;
        @SerializedName("water")public int water;
        @SerializedName("cold")public int cold;
