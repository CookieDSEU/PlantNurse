 ...
 * SQLiteDatabase db1 = mg.getDatabase("db1.db"); // get SQLiteDatabase object,
 * db1.db is a file in assets folder db1.??? // every operate by you want Of
 * cause, you can use AssetsDatabaseManager.getManager().getDatabase("xx") to
 * get a database when you need use a database
 */
public class AssetsDatabaseManager {
    private static String tag = "AssetsDatabase"; // for LogCat
    private static String databasepath = "/data/data/com.plantnurse.plantnurse/database";
