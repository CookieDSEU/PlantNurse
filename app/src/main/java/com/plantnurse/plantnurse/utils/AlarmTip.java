 ...
 */
public class AlarmTip extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 播放闹铃
        final Intent intentSV = new Intent(AlarmTip.this, MyService.class);
        ...
        new AlertDialog.Builder(AlarmTip.this).setTitle("闹钟").setMessage(mtext)
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        stopService(intentSV);
                        AlarmTip.this.finish();
                        info.update(alarm);
                    }
                }).show();
